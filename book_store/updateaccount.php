...
// build SELECT query
         $sql ="UPDATE PET_ACCOUNT SET PASSWORD='$pass', EMAIL='$email', PHONE = '$phone', ADDRESS = '$address'  WHERE USERID= '$userid'";
       ...
       <div class="center_content">
       	<div class="left_content">
			...
			echo '<p> Update successful</p><br />
					<a href="myaccount.php" class="continue">Back to My Account</a>';
